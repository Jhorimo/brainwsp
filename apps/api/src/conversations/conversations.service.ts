...
export class ConversationsService {
    ...
    return this.prisma.conversation.findMany({
      ...
      include: {
        ...
        messages: {
          ...
          select: { id: true, body: true, caption: true, type: true, direction: true, status: true, createdAt: true },
        },
      },
  ...
  async update(
    ...
    data: { status?: ConversationStatus; assignedUserId?: string | null; departmentId?: string | null },
  ) {
    await this.getOwned(companyId, conversationId);
