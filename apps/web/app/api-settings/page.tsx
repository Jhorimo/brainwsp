...
type Credential = { id: string; name: string; appKey: string; hasAuthKey: boolean; instanceId: string; active: boolean; lastUsedAt?: string | null; createdAt: string; instance?: { id: string; name: string; slug: string; status: string } | null };
